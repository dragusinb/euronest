    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'Progressive 1-40% depending on relationship', details: 'Category A (spouse, children, parents): tax-free up to €150,000, then 1-10%. Category B (siblings, grandparents): tax-free up to €30,000, then 5-20%. Category C (others): tax-free up to €6,000, then 20-40%. Greece taxes worldwide inheritance for residents, and Greek property inheritance for non-residents. Important: Greek forced heirship rules may override your will.', severity: 'neutral' },
          { label: 'Greece-Romania double taxation treaty', value: 'Treaty exists - property taxed in Greece, credit in Romania', details: 'The Greece-Romania double taxation agreement ensures rental income from Greek property is taxed in Greece at Greek rates (15-45%). Romania provides a tax credit for the Greek tax paid. Capital gains on Greek property are taxed in Greece (currently suspended). File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax (non-resident)', value: 'Progressive 5-45% for non-relatives', details: 'France applies inheritance tax regardless of the deceased\'s residency if the property is in France. Rates: 5% up to €8,072, 10% up to €12,109, 15% up to €15,932, 20% up to €552,324, 30% up to €902,838, 40% up to €1,805,677, 45% above. Direct descendants get a €100,000 allowance per parent. Spouses/PACS partners are exempt. This applies even if you are Romanian - France will tax the French property.', severity: 'restrictive' },
          { label: 'Capital gains on sale (non-resident)', value: '19% + 17.2% social charges = 36.2% total', details: 'Non-residents pay 19% income tax + 17.2% social charges on capital gains when selling French property. Taper relief applies: full income tax exemption after 22 years, full social charges exemption after 30 years. EU/EEA residents may qualify for reduced social charges (7.5% instead of 17.2%) if affiliated to home country social security. One exemption of up to €150,000 of gains available for non-residents.', severity: 'restrictive' },
          { label: 'France-Romania double taxation treaty', value: 'Treaty exists - property income taxed in France, credit in Romania', details: 'Under the France-Romania tax treaty (1974), rental income from French property is taxable in France. Romania gives a tax credit for French tax paid to avoid double taxation. Capital gains on immovable property are also taxable in France. Romania exempts this income if it was already taxed in France, or gives a credit. You must file tax returns in both countries but should not pay tax twice on the same income.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'Progressive 7-33% for close relatives', details: 'Category I (spouse, children, parents): 7% up to €25,000, 10% up to €55,000, 13% up to €200,000, 16% up to €1M, 19% above. Category II (others): 19-33%. Tax-free amount: €20,000. Finland taxes Finnish property inheritance regardless of the owner\'s residency.', severity: 'neutral' },
          { label: 'Finland-Romania double taxation treaty', value: 'Treaty exists - standard OECD model', details: 'Finland and Romania have a comprehensive double taxation treaty. Rental income from Finnish property is taxable in Finland (30-34% capital income tax). Romania provides a credit for Finnish tax paid. Same applies to capital gains on Finnish property.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax (Impuesto de Sucesiones)', value: 'Progressive 7.65-34%, highly variable by region', details: 'Spanish inheritance tax varies enormously by autonomous community. National rates: 7.65-34%. However, regions set multipliers and exemptions: Andalusia nearly exempt for close family, Madrid applies 99% reduction for direct heirs, while Valencia and Catalonia are less generous. Non-residents pay national rates. Forced heirship rules (legítima) reserve 2/3 of estate for children. Spain taxes Spanish property inheritance regardless of owner\'s residency.', severity: 'restrictive' },
          { label: 'Spain-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Spain, credit in Romania', details: 'Under the Spain-Romania double taxation treaty, rental income and capital gains from Spanish property are taxable in Spain. Romania provides a tax credit for Spanish tax paid to avoid double taxation. You must file tax returns in both countries. The 3% non-resident withholding on property sales is creditable against Romanian tax.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'No inheritance tax - only 10% stamp duty', details: 'Portugal abolished inheritance tax in 2004. However, a 10% stamp duty (Imposto do Selo) applies to Portuguese assets transferred by death or gift, except for transfers to spouses, descendants, and ascendants (who are exempt from stamp duty). This makes Portugal very favorable for family inheritance of property.', severity: 'favorable' },
          { label: 'Portugal-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Portugal, credit in Romania', details: 'Under the Portugal-Romania double taxation treaty, rental income and capital gains from Portuguese property are taxable in Portugal. Romania provides a tax credit for Portuguese tax paid. File returns in both countries to claim the credit and avoid double taxation.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Italy-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Italy, credit in Romania', details: 'Under the Italy-Romania double taxation treaty, rental income and capital gains from Italian property are taxable in Italy. Romania provides a tax credit for Italian tax paid to avoid double taxation. Italy\'s cedolare secca (21%) rate is often lower than progressive rates, making the credit straightforward. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax (Erbschaftsteuer)', value: 'Progressive 7-50%, generous family exemptions', details: 'German inheritance tax rates: Class I (spouse, children, parents): 7-30%. Class II (siblings, nieces/nephews): 15-43%. Class III (unrelated): 30-50%. Exemptions: €500,000 for spouse, €400,000 per child, €200,000 for grandchildren. Family home exemption if spouse/children continue living there. Germany taxes German property inheritance regardless of the owner\'s residency. Very complex rules - professional advice essential.', severity: 'restrictive' },
          { label: 'Germany-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Germany, credit in Romania', details: 'Under the Germany-Romania double taxation treaty, rental income and capital gains from German property are taxable in Germany. Romania provides a tax credit for German tax paid. After 10 years of ownership, German capital gains are tax-free, eliminating the need for a credit on gains. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax (erfbelasting)', value: 'Progressive 10-40%, varies by relationship', details: 'Dutch inheritance tax rates: Partner: 10-20% (exemption €795,156). Children: 10-20% (exemption €25,187 each). Grandchildren: 18-36%. Others: 30-40% (exemption €2,658). Netherlands taxes worldwide assets of Dutch residents and Dutch property of non-residents. Complex anti-avoidance rules apply, including deemed residency provisions for emigrants within 10 years.', severity: 'restrictive' },
          { label: 'Netherlands-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Netherlands, credit in Romania', details: 'Under the Netherlands-Romania double taxation treaty, property income (Box 3 deemed return) and capital gains from Dutch property are taxable in the Netherlands. Romania provides a tax credit for Dutch tax paid. The Dutch Box 3 system taxes deemed rather than actual returns, which can complicate credit calculations. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax (successierechten/droits de succession)', value: 'High rates, varies by region (3-80%)', details: 'Belgian inheritance tax varies by region. Flanders: direct heirs 3-27%, others up to 55%. Brussels: direct heirs 3-30%, others up to 80%. Wallonia: direct heirs 3-30%, others up to 80%. No tax-free allowance for property (unlike movable assets). Belgium taxes worldwide assets of Belgian residents and Belgian property of non-residents. Rates are among Europe\'s highest for non-family.', severity: 'restrictive' },
          { label: 'Belgium-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Belgium, credit in Romania', details: 'Under the Belgium-Romania double taxation treaty, rental income from Belgian property is taxable in Belgium (based on cadastral income system). Romania provides a tax credit for Belgian tax paid. Capital gains on Belgian property (exempt after 5 years) follow the same treaty allocation. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'No inheritance tax - only 3.5% transfer charge', details: 'Austria abolished inheritance tax in 2008. However, a real estate transfer tax (Grunderwerbsteuer) of 3.5% applies when property changes hands by inheritance, plus 1.1% land registry fee. For close family members, a reduced basis (3x the assessed value instead of market value) may apply. No additional death duties. This makes Austria relatively favorable for property inheritance.', severity: 'favorable' },
          { label: 'Austria-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Austria, credit in Romania', details: 'Under the Austria-Romania double taxation treaty, rental income and capital gains from Austrian property are taxable in Austria. Romania provides a tax credit for Austrian tax paid. Austria\'s 30% ImmoESt on capital gains is credited against Romanian tax liability. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax (Capital Acquisitions Tax)', value: '33% above thresholds', details: 'Ireland\'s Capital Acquisitions Tax (CAT) applies at 33% above group thresholds. Group A (children): €335,000 tax-free. Group B (siblings, grandchildren): €32,500. Group C (others): €16,250. Irish property is always within scope regardless of residency. Agricultural relief (90% reduction) and business relief available in some cases. Dwelling house exemption may apply if beneficiary lived in the property.', severity: 'restrictive' },
          { label: 'Ireland-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Ireland, credit in Romania', details: 'Under the Ireland-Romania double taxation treaty, rental income and capital gains from Irish property are taxable in Ireland. Romania provides a tax credit for Irish tax paid. Ireland\'s high marginal rates (up to 52% on rental income, 33% CGT) mean the credit usually covers the full Romanian liability. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'Group I (family) up to 7%, significant exemptions', details: 'Polish inheritance tax: Group I (spouse, children, parents, siblings, stepchildren): 3-7% above PLN 36,120. Group II (extended family): 7-12%. Group III (others): 12-20%. However, closest family members (Group 0: spouse, children, parents, siblings) are fully exempt if they notify the tax office within 6 months. Poland taxes Polish property inheritance regardless of the deceased\'s residency.', severity: 'neutral' },
          { label: 'Poland-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Poland, credit in Romania', details: 'Under the Poland-Romania double taxation treaty, rental income and capital gains from Polish property are taxable in Poland. Romania provides a tax credit for Polish tax paid. Poland\'s favorable 8.5%rycza\u0142t rate means lower tax burden and corresponding lower credit. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'No inheritance tax (abolished 2014)', details: 'The Czech Republic abolished inheritance tax in 2014. Inherited property is not subject to any transfer tax or duty. This makes the Czech Republic one of the most favorable countries in Europe for property inheritance. Note: inherited income may be subject to income tax in some circumstances, but property transfers by death are generally tax-free.', severity: 'favorable' },
          { label: 'Czech Republic-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Czech Republic, credit in Romania', details: 'Under the Czech Republic-Romania double taxation treaty, rental income and capital gains from Czech property are taxable in the Czech Republic. Romania provides a tax credit for Czech tax paid. Czech Republic\'s favorable 15% flat rate and 5-year exemption for capital gains make this straightforward. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: '18% flat rate, 9% for direct family', details: 'Hungarian inheritance tax: 18% flat rate for most beneficiaries, reduced to 9% for direct-line relatives (children, parents, spouse). Exemptions apply: residential property inherited by surviving spouse or children who lived in the property may be partially or fully exempt. Hungary taxes Hungarian property inheritance regardless of the deceased\'s residency.', severity: 'neutral' },
          { label: 'Hungary-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Hungary, credit in Romania', details: 'Under the Hungary-Romania double taxation treaty, rental income and capital gains from Hungarian property are taxable in Hungary. Romania provides a tax credit for Hungarian tax paid. Given geographic proximity and cultural ties, this treaty is particularly relevant for Romanian investors. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'No inheritance tax - notarial fees 1-5%', details: 'Romania does not levy an inheritance tax as such. However, notarial fees of 1-5% apply when transferring inherited property (based on property value, degressive scale). A certificate of heir (certificat de mo\u0219tenitor) is required, obtained through a notarial succession procedure. If the succession is contested, court proceedings may be needed. Overall, Romania is very favorable for inheritance.', severity: 'favorable' },
          { label: 'Romania as tax residence', value: 'Credit method for foreign property income', details: 'As a Romanian tax resident, you must declare worldwide income including foreign rental income and capital gains. Romania applies the credit method: tax paid abroad on property income is credited against Romanian tax liability, up to the Romanian tax that would be due on that income. This prevents double taxation. Romania has an extensive network of double taxation treaties with most EU countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'No tax for first-degree relatives, 4% for others', details: 'Croatia does not charge inheritance tax for first-degree relatives (spouse, children, parents). Other heirs pay 4% of the property value. The tax is levied as a property transfer tax equivalent. Croatia taxes Croatian property inheritance regardless of the deceased\'s residency. No forced heirship rules that would override a valid will.', severity: 'favorable' },
          { label: 'Croatia-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Croatia, credit in Romania', details: 'Under the Croatia-Romania double taxation treaty, rental income and capital gains from Croatian property are taxable in Croatia. Romania provides a tax credit for Croatian tax paid. Croatia\'s favorable 10% flat rate and 2-year capital gains exemption make the tax burden light. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax (boafgift)', value: '15% for close family, 36.25% for others', details: 'Danish inheritance tax: 15% for close family (spouse exempt, children, grandchildren, parents). An additional 25% tax applies to distant relatives and non-family, bringing the effective rate to 36.25%. Tax-free allowance of approximately DKK 321,700 per beneficiary. Denmark taxes Danish property inheritance regardless of the deceased\'s residency.', severity: 'restrictive' },
          { label: 'Denmark-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Denmark, credit in Romania', details: 'Under the Denmark-Romania double taxation treaty, rental income and capital gains from Danish property are taxable in Denmark. Romania provides a tax credit for Danish tax paid. Denmark\'s high marginal rates (up to 52%) mean the credit usually covers the full Romanian liability. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'No inheritance tax (abolished 2005)', details: 'Sweden abolished inheritance tax in 2005. No tax is due on inherited property regardless of value or relationship to the deceased. This makes Sweden one of the most favorable countries in Europe for property inheritance. Note: capital gains tax applies when the inherited property is eventually sold, with the original acquisition cost as the tax base.', severity: 'favorable' },
          { label: 'Sweden-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Sweden, credit in Romania', details: 'Under the Sweden-Romania double taxation treaty, rental income and capital gains from Swedish property are taxable in Sweden. Romania provides a tax credit for Swedish tax paid. Sweden\'s 30% capital income tax rate and 22% effective capital gains rate are credited against Romanian liability. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'No inheritance tax (abolished 2014)', details: 'Norway abolished inheritance tax in 2014. No tax is due on inherited property regardless of value or relationship. This makes Norway very favorable for property inheritance. However, the heir takes over the deceased\'s tax basis (continuity principle), so capital gains tax applies on the difference when the property is eventually sold.', severity: 'favorable' },
          { label: 'Norway-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Norway, credit in Romania', details: 'Under the Norway-Romania double taxation treaty, rental income and capital gains from Norwegian property are taxable in Norway. Romania provides a tax credit for Norwegian tax paid. Norway\'s high marginal rates (up to 47.4%) and wealth tax should be considered. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'No inheritance tax', details: 'Estonia does not levy any inheritance tax or estate duty. Property passes to heirs without any tax liability. This makes Estonia one of the most favorable countries in Europe for property inheritance. The heir inherits the property at market value, and no capital gains tax applies until the property is sold.', severity: 'favorable' },
          { label: 'Estonia-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Estonia, credit in Romania', details: 'Under the Estonia-Romania double taxation treaty, rental income and capital gains from Estonian property are taxable in Estonia at 20%. Romania provides a tax credit for Estonian tax paid. Estonia\'s unique corporate tax system (0% on retained earnings) can be advantageous if property is held through an Estonian company. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'No inheritance tax for family, favorable overall', details: 'Latvia does not levy inheritance tax on transfers to family members (spouse, children, parents, grandchildren, siblings). Other heirs may be subject to personal income tax on the inherited value. Property registration fees apply (~2% stamp duty on transfer). Overall, Latvia is favorable for family inheritance of property.', severity: 'favorable' },
          { label: 'Latvia-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Latvia, credit in Romania', details: 'Under the Latvia-Romania double taxation treaty, rental income and capital gains from Latvian property are taxable in Latvia. Romania provides a tax credit for Latvian tax paid. Latvia\'s favorable 10% micro-enterprise rate for rental income results in a low tax burden. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'Progressive 5-10%, many exemptions', details: 'Lithuanian inheritance tax: 5% on inherited property valued up to €150,000, 10% above. Exemptions: close family members (spouse, children, parents, grandchildren, grandparents, siblings) are fully exempt. Non-family heirs pay the progressive rates. Lithuania taxes Lithuanian property inheritance regardless of the deceased\'s residency.', severity: 'neutral' },
          { label: 'Lithuania-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Lithuania, credit in Romania', details: 'Under the Lithuania-Romania double taxation treaty, rental income and capital gains from Lithuanian property are taxable in Lithuania. Romania provides a tax credit for Lithuanian tax paid. Lithuania\'s 15% flat rate and favorable business license regime result in moderate tax burden. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Inheritance tax', value: 'No inheritance tax (abolished 2000)', details: 'Cyprus abolished inheritance and estate duty in 2000. No tax is due on inherited property regardless of value or relationship to the deceased. This makes Cyprus one of the most favorable jurisdictions for property inheritance. Only property transfer fees may apply when registering the inherited property (which may also be waived or reduced).', severity: 'favorable' },
          { label: 'Cyprus-Romania double taxation treaty', value: 'Treaty exists - property income taxed in Cyprus, credit in Romania', details: 'Under the Cyprus-Romania double taxation treaty, rental income and capital gains from Cypriot property are taxable in Cyprus. Romania provides a tax credit for Cypriot tax paid. Cyprus\'s 12.5% corporate tax rate and favorable non-domicile regime can significantly reduce tax burden. File returns in both countries.', severity: 'neutral' }
        ]
      },
      {
        id: 'visa',
